 ...
 */
package com.zero.base.sys.core.auth;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.convert.Convert;
import com.zero.base.auth.context.LoginContextHolder;
import com.zero.base.auth.exception.AuthException;
import com.zero.base.auth.exception.enums.AuthExceptionEnum;
import com.zero.base.auth.jwt.JwtTokenUtil;
import com.zero.base.auth.jwt.payload.JwtPayLoad;
import com.zero.base.auth.model.LoginUser;
...
import com.zero.base.common.tenant.context.DataBaseNameHolder;
import com.zero.base.common.tenant.context.TenantCodeHolder;
import com.zero.base.sys.core.auth.cache.SessionManager;
import com.zero.base.sys.core.constant.factory.ConstantFactory;
import com.zero.base.sys.core.constant.state.ManagerStatus;
import com.zero.base.sys.core.listener.ConfigListener;
import com.zero.base.sys.core.log.LogManager;
import com.zero.base.sys.core.log.factory.LogTaskFactory;
import com.zero.base.sys.core.util.SaltUtil;
import com.zero.base.sys.modular.system.entity.User;
import com.zero.base.sys.modular.system.factory.UserFactory;
import com.zero.base.sys.modular.system.mapper.MenuMapper;
import com.zero.base.sys.modular.system.mapper.UserMapper;
import com.zero.base.sys.modular.system.service.DictService;
...
public class AuthServiceImpl implements AuthService {
    ...
    public String login(String username) {
        ...
        //记录登录日志
        LogManager.me().executeLog(LogTaskFactory.loginLog(user.getUserId(), HttpContext.getIp()));
    ...
    public void logout(String token) {
        ...
        //记录退出日志
        LogManager.me().executeLog(LogTaskFactory.exitLog(LoginContextHolder.getContext().getUser().getId(), HttpContext.getIp()));
